        ...
        routeInit: function (e) {
            var t = this, a = {
                ...
                routes: [
                    ...
                    {path: "/", component: "pages/works/list.html", name: "主页"},

                    {path: "/works/list", component: "pages/works/list.html", name: "作品work"},
                    {path: "/works/info", component: "pages/works/info.html", name: "编辑作品"},

                    {path: "/article/list", component: "pages/article/list.html", name: "评论文章"},
                    {path: "/article/info", component: "pages/article/info.html", name: "编辑文章"},

                    {path: "/exp/list", component: "pages/exp/list.html", name: "经历"},
                    {path: "/exp/info", component: "pages/exp/info.html", name: "编辑经历"},
                ]
            };
