...
;(function($) {
    ...
    sangarBaseClass = function(base, opt) {
        ...
        {
            var maxWidth = reinit ? base.sangarWidth : (opt.width + opt.paginationContentWidth);
            var height = reinit ? base.sangarHeight : opt.height;

            // width
            if(reinit && !opt.scaleSlide)
            {
                maxWidth = opt.width + opt.paginationContentWidth;
            }
            ...
            // apply size
            base.$el.css({
                'height': containerHeight- opt.paginationContentWidth + 'px',
                'max-width': maxWidth + 'px'
            });

            base.$sangarWrapper.css({
                'height': containerHeight + 'px',
                'margin-left': opt.paginationContentWidth + 'px'

            });

            base.$sangar.css({
                'height': height + 'px',
                'max-width': maxWidth- opt.paginationContentWidth + 'px'
            });
        }
