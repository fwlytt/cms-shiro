...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        shiroFilterFactoryBean.setLoginUrl("/pages/show/index/0");//登录连接
        shiroFilterFactoryBean.setSuccessUrl("/home");//登录成功后跳转的连接
        shiroFilterFactoryBean.setUnauthorizedUrl("/pages/show/index/0"); //未授权跳转页面
        ...
        filterChainDefinitionMap.put("/pages/show/**", "anon");
        ...
        filterChainDefinitionMap.put("/workImage/**","anon");
